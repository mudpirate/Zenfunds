...
import addExpenseRecord from "@/app/actions/addExpense";
...
const AddRecord = () => {
  ...
  return (
    <div className=" min-h-screen px-3 py-2 w-[78vw]">
      <div className="bg-white/80 border h-full w-full dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl  dark:border-gray-700/50 hover:shadow-2xl">
        ...
        <div className="">
          ...
          >
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <span className="text-xs text-gray-400 dark:text-gray-500 ml-2 font-normal hidden sm:inline">
                    Use the AI button above for AI suggestions
                  </span>
                </label>
                <select
                  id="category"
            ...
            <button
              type="submit"
              className="w-full relative mt-30 overflow-hidden bg-green-800 hover:from-emerald-700 hover:via-green-600 hover:to-teal-600 text-white px-4 py-3 sm:px-5 sm:py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl group transition-all duration-300 border-2 border-transparent hover:border-white/20 text-sm sm:text-base"
              disabled={isLoading}
            >
