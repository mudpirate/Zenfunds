...
const ExpenseStats = async () => {
  try {
    ...
    return (
      <div className="bg-white/80  dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl  border-black dark:border-gray-700/50 hover:shadow-2xl">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            {/* Highest Expense */}
            <div className="bg-red-300 dark:bg-red-900/20 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-red-500 hover:bg-red-50 dark:hover:bg-red-900/30">
            ...
            {/* Lowest Expense */}
            <div className="bg-green-200 dark:bg-green-900/20 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-green-500 hover:bg-green-50 dark:hover:bg-green-900/30">
              <div className="flex items-center gap-2">
