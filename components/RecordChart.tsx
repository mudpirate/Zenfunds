...
const RecordChart = async () => {
  ...
  if (error) {
    return (
      <div className="bg-white/80 dark:bg-black backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
