...
const RecordHistory = async () => {
  ...
  if (error) {
    return (
      <div className="bg-white/80 dark:bg-black min-h-screen backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50">
        <div className="flex items-center gap-2 sm:gap-3 dark:bg-black mb-4 sm:mb-6">
  ...
  return (
    <div className="bg-white/80 mt-3 mx-2  dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl  dark:border-gray-700/50 hover:shadow-2xl">
      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
        <div>
          <h3 className="text-lg  sm:text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent">
            Expense History
          </h3>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
            Your spending timeline
