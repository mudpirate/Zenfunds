...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="relative w-8 h-8 bg-white dark:from-emerald-900/80 dark:to-green-900/80 backdrop-blur-sm rounded-full shadow-lg border border-emerald-200/50 dark:border-emerald-700/50">
    ...
    >
      ...
      <div
        className={`absolute top-0.5 w-7 h-7 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center transition-all duration-300 transform group-hover:scale-110 ${
          theme === "light"
            ? "left-0.5 bg-white dark:from-gray-800 dark:to-gray-700"
            : "left-6 bg-white dark:from-gray-700 dark:to-gray-800"
        }`}
      >
        <span
